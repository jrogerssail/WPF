...
var tvSize = prompt("What size TV are you looking to purchase?");
var tvStock = 27; 		//sets up index
while(tvStock > 0){		//checks condition
	console.log(tvStock + 'These are you TV choices');
